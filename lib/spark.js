...
(function( window, $, undefined ){
    ...
    var Obj = (function(){
        ...
        /// Creates a new instace of Object.
        ///
        /// @param {Object?} properties Optional object of starting properties.
        ///
        ...
        ObjProto.set = function( name, value ){
            ...
            var eventData   = { oldValue : prop.value };
            prop.value = value;
            _triggerPropertyEvent.call( this, EVENT_CHANGE, prop, eventData );
            return this;
        };
    ...
    var View = (function(){
        ...
        function View( template, target, locals ){
            Obj.call( this, VIEW_PROPERTIES );
            this[ OBJECT_TYPES ].push( View );
        }
