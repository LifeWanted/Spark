...
(function( window, $, undefined ){
    ...
    var View = (function(){
        ...
        function _checkTemplateVariable( match, variable, flags, offset, template ){
            if( FLAG_IGNORE.test( flags ) ){
            }
                ...
                return VIEW_RECAST_EVENT + variable;
            }
            else {
                _bindObserver.call( this, variable.split( '.' ) );
            }
        ...
        function _bindObserver( path ){
            ...
            obj.observe( path[ lastIndex ], _triggerBuildTemplate.bind( self ) );
            return self;
        }
        ...
        function _buildTemplate(){
            ...
            self.increment( 'builds' );
            $target.html( self[ VIEW_TEMPLATE ]( self[ VIEW_LOCALS ].normalize() ) );
        ...
        function _recastEvent( event ){
            $( this ).trigger( Event( event.type + EVENT_NAMESPACE, event ) );
        }

        // -------------------------------------------------------------------------------------- //

        /// Constructs a new Spark.View instance.
        ///
        ///
        /// @param {String}     template    The template to build.
        /// @param {jQuery}     target      The element(s) to put the built template into.
        /// @param {Object?}    locals      The values to build the template with.
        ///
        /// @return {Spark.View} A new Spark.View instance.
        View.new = function(){
